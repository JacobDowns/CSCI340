...
\newpage
\sectionbar{Section B}{Natural join and theta join \quad 20 points}
...
\question{B3}{Read and trace a theta join}{7}
...
\begin{enumerate}[label=\alph*.]
  ...
  \item Write every output tuple. Tuple order does not matter. \hfill (5)
\end{enumerate}
\anspace{3.1in}
